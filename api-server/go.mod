module github.com/gasmod/gas-examples/api-server

go 1.26.1

require (
	github.com/gasmod/gas v0.3.1
	github.com/gasmod/gas-auth v0.3.1
	github.com/gasmod/gas-cache v0.3.1
	github.com/gasmod/gas-config v0.3.1
	github.com/gasmod/gas-database v0.3.1
	github.com/gasmod/gas-email v0.3.1
	github.com/gasmod/gas-log v0.3.1
	github.com/gasmod/gas-migrate v0.3.1
	github.com/gasmod/gas-queue v0.3.1
	github.com/gasmod/gas-storage v0.3.1
	github.com/gasmod/gas-template v0.3.1
